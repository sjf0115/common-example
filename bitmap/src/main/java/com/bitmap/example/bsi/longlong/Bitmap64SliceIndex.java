...
public interface Bitmap64SliceIndex {
    int bitCount();
     ...
     */
    void setValue(long columnId, long value);
     ...
     */
    Pair<Long, Boolean> getValue(long columnId);

    /**
     * Set a batch of values.
     * @param values
     */
    void setValues(List<Pair<Long, Long>> values);
