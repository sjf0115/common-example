...
import com.bitmap.example.bsi.buffer.ImmutableBitSliceIndex;
import com.bitmap.example.bsi.buffer.MutableBitSliceIndex;
...
public class BufferBSITest {
    ...
    public void testAddAndEvaluate() {
        ...
        ImmutableRoaringBitmap result = bsiA.compare(Operation.EQ, 120, 0, null);
    ...
    public void testNotEQ() {
        ...
        ImmutableRoaringBitmap result = bsi.compare(Operation.NEQ, 99, 0, null);
    ...
    @Test
    public void testGT()  {
        ImmutableRoaringBitmap result = imBsi.compare(Operation.GT, 50, 0, null);
        ...
        result = imBsi.compare(Operation.GT, 0, 0, null);
        Assertions.assertTrue(result.getLongCardinality() == 99);
        Assertions.assertArrayEquals(IntStream.range(1, 100).toArray(), result.toArray());

        result = imBsi.compare(Operation.GT, 99, 0, null);
        Assertions.assertTrue(result.isEmpty());
    }
    ...
    @Test
    public void testGE()  {
        ImmutableRoaringBitmap result = imBsi.compare(Operation.GE, 50, 0, null);
        ...
        result = imBsi.compare(Operation.GE, 1, 0, null);
        Assertions.assertTrue(result.getLongCardinality() == 99);
        Assertions.assertArrayEquals(IntStream.range(1, 100).toArray(), result.toArray());

        result = imBsi.compare(Operation.GE, 100, 0, null);
        Assertions.assertTrue(result.isEmpty());
    }

    @Test
    public void testLT()  {
        ImmutableRoaringBitmap result = imBsi.compare(Operation.LT, 50, 0, null);
        Assertions.assertTrue(result.getLongCardinality() == 49);
        Assertions.assertArrayEquals(IntStream.range(1, 50).toArray(), result.toArray());

        result = imBsi.compare(Operation.LT, Integer.MAX_VALUE, 0, null);
        Assertions.assertTrue(result.getLongCardinality() == 99);
        Assertions.assertArrayEquals(IntStream.range(1, 100).toArray(), result.toArray());

        result = imBsi.compare(Operation.LT, 1, 0, null);
        Assertions.assertTrue(result.isEmpty());
    }
    ...
    @Test
    public void testLE()  {
        ImmutableRoaringBitmap result = imBsi.compare(Operation.LE, 50, 0, null);
        Assertions.assertTrue(result.getLongCardinality() == 50);
        Assertions.assertArrayEquals(IntStream.range(1, 51).toArray(), result.toArray());

        result = imBsi.compare(Operation.LE, Integer.MAX_VALUE, 0, null);
        Assertions.assertTrue(result.getLongCardinality() == 99);
        Assertions.assertArrayEquals(IntStream.range(1, 100).toArray(), result.toArray());

        result = imBsi.compare(Operation.LE, 0, 0, null);
        Assertions.assertTrue(result.isEmpty());
    }

    @Test
    public void testRANGE()  {
        ImmutableRoaringBitmap result = imBsi.compare(Operation.RANGE, 10, 20, null);
        ...
        result = imBsi.compare(Operation.RANGE, 1, 200, null);
        Assertions.assertTrue(result.getLongCardinality() == 99);
        Assertions.assertArrayEquals(IntStream.range(1, 100).toArray(), result.toArray());

        result = imBsi.compare(Operation.RANGE, 1000, 2000, null);
        Assertions.assertTrue(result.isEmpty());
    }
    ...
    public void testValueZero() {
        ...
        ImmutableRoaringBitmap result = bsi.compare(Operation.EQ, 0, 0, null);
        Assertions.assertTrue(result.getLongCardinality() == 2);
